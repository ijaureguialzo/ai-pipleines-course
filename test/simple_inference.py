...
def analyze_text(text, model_name="Qwen/Qwen3-0.6B",
                 prompt_template="Analyze this text and provide insights about its content, tone, and key points: {text}"):
    # Force CPU usage
...
if __name__ == "__main__":
    ...
    analysis = analyze_text(text, model_name="Qwen/Qwen3-0.6B")  # cambia aqui el modelo texto y prompt
